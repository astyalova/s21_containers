...
namespace s21 {
template <class T, size_t N> array<T, N>::array() : size_(N), array_{} {}
...
template <class T, size_t N> array<T, N>::array(array &&a) : size_(a.size_) {
...
template <class T, size_t N> bool array<T, N>::empty() { return size_ == 0; }
